...
public class UPRBTests {
	...
	public static void GetUserMapRole200ValidationGetAll(Response response) {
	...
	//Get User id
	public static void GetUserMapRole200ValidationUserID(Response response) {
		
		try {
			String jsonSchema = FileUtils.readFileToString(new File(FileNameConstants.UsersMapRoleGetUserId_JSON_SCHEMA), "UTF-8");		
	...
	//Delete
	public static void GetUserMapRole200ValidationDelete(Response response) {
