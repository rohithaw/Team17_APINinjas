...
public class dynamicGenerator {
	...
	private static int PositiveProgramcounter =114;
	private static int PositiveBatchcounter = 104;
	private static int UserPhonecounter = 47;
	private static int UserEmailcounter = 47;
