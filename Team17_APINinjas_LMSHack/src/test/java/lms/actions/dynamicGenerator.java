...
public class dynamicGenerator {
	...
	private static int PositiveProgramcounter =1;
	private static int PositiveBatchcounter = 1;
	private static int UserPhonecounter = 1;
	private static int UserEmailcounter = 1;
